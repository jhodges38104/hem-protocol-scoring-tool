...
> **This is an unvalidated draft instrument (v0.1).** Don't use the output alone to justify a staffing or budget decision. Full detail: [rubric.md](rubric.md).
...
- **When to score:** at feasibility review (before the study is committed to), then again every year, and again on any amendment that touches visit schedule, IP handling, data systems, or safety monitoring.
